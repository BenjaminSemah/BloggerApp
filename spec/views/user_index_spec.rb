  ...
  describe 'User index page' do
    before(:each) do
      ...
      @first_user = User.create(name: 'Edmond', photo: 'url', bio: 'Designer from Ghana',
                                posts_counter: 0, email: 'edmond@mail.com', password: 'password', password_confirmation: 'password')
      @second_user = User.create(name: 'Theo', photo: 'url', bio: 'Developer from Ghana',
                                posts_counter: 0, email: 'theo@mail.com', password: 'password', password_confirmation: 'password')
