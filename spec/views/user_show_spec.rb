...
RSpec.describe 'user_show_path', type: :feature do
  describe 'User show page' do
    before(:each) do
      ...
      @first_post = Post.create(user: @first_user, title: 'Finding Dora', text: 'This is my first post')
      @second_post = Post.create(user: @first_user, title: 'Finding Dora', text: 'This is my second post')
      @third_post = Post.create(user: @first_user, title: 'Finding Dora', text: 'This is my third post')
